...
def squeezenet1_0(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = SqueezeNet(
...
def squeezenet1_0_fc512(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = SqueezeNet(
...
def squeezenet1_1(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = SqueezeNet(
