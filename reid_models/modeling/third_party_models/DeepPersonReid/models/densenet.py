...
def densenet121(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = DenseNet(
...
def densenet169(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = DenseNet(
        num_classes=num_classes,
        loss=loss,
        num_init_features=64,
...
def densenet201(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = DenseNet(
        num_classes=num_classes,
        loss=loss,
        num_init_features=64,
...
def densenet161(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = DenseNet(
        num_classes=num_classes,
        loss=loss,
...
def densenet121_fc512(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = DenseNet(
        num_classes=num_classes,
        loss=loss,
        num_init_features=64,
