...
def osnet_x0_75(num_classes=1000, pretrained=True, loss="triplet", **kwargs):
...
def osnet_x0_5(num_classes=1000, pretrained=True, loss="triplet", **kwargs):
...
def osnet_x0_25(num_classes=1000, pretrained=True, loss="triplet", **kwargs):
...
def osnet_ibn_x1_0(num_classes=1000, pretrained=True, loss="triplet", **kwargs):
