...
def shufflenet_v2_x0_5(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = ShuffleNetV2(
...
def shufflenet_v2_x1_0(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = ShuffleNetV2(
...
def shufflenet_v2_x1_5(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = ShuffleNetV2(
...
def shufflenet_v2_x2_0(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = ShuffleNetV2(
