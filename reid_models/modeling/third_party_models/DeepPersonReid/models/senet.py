...
def senet154(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = SENet(
...
def se_resnet50(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = SENet(
        num_classes=num_classes,
        loss=loss,
...
def se_resnet50_fc512(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = SENet(
        num_classes=num_classes,
        loss=loss,
        block=SEResNetBottleneck,
...
def se_resnet101(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = SENet(
        num_classes=num_classes,
        loss=loss,
        block=SEResNetBottleneck,
...
def se_resnet152(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = SENet(
        num_classes=num_classes,
        loss=loss,
        block=SEResNetBottleneck,
...
def se_resnext50_32x4d(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = SENet(
        num_classes=num_classes,
        loss=loss,
...
def se_resnext101_32x4d(num_classes, loss="triplet", pretrained=True, **kwargs):
    model = SENet(
        num_classes=num_classes,
        loss=loss,
        block=SEResNeXtBottleneck,
